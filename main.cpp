...
#pragma region PSO
	...
	//shaderのコンパイラ
	IDxcBlob* vertexShaderBlob = dxCommon->CompileShader(L"resource/shaders/Object3d.VS.hlsl", L"vs_6_0");
	assert(vertexShaderBlob != nullptr);

	IDxcBlob* pixelShaderBlob = dxCommon->CompileShader(L"resource/shaders/Object3d.PS.hlsl", L"ps_6_0");
...
#pragma endregion
	...
	//Microsoft::WRL::ComPtr<ID3D12Resource> depthStencilResource2 = dxCommon->CreateDepthStencilTextureResource(WinApp::kClientWidth, WinApp::kClientHeight);

	//DSVようのヒープでディスクリプタの数1、shader内で触らないのでfalse
	//Microsoft::WRL::ComPtr < ID3D12DescriptorHeap> dsvDescriptorHeap2 = dxCommon->CreateDescriptorHeap(D3D12_DESCRIPTOR_HEAP_TYPE_DSV, 1, false);
	...
	////SRVの生成
	//dxCommon->GetDevice()->CreateShaderResourceView(textureResource.Get(), &srvDesc, textureSrvHandleCPU2);
